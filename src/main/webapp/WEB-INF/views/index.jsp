...
<html lang="en">
    <head>
        <title>CRM Project mhk</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
            <link rel="stylesheet" type="text/css" href="css/mystt.css">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li> <a href="/profile" class="dropdown-item"> Profile Demo </a> </li>
        ...
        <div class="container-fluid">
            <div class="row main_page_banner">
                ...
                <div class="col-4" style="padding: 50px">
                    <img src="images/index_image.png" height="300" />
                </div>
            </div>
        </div>
        
        <div class="container-fluid">
            <div class="container" style="float: left; padding-top: 20px">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <ul>
                            ...
                            <li>Intelligently captures customer Email.</li>
